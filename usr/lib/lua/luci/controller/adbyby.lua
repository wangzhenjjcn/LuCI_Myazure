...
e=luci.sys.exec("/usr/share/adbyby/rule-count '/tmp/rules/'")
...
if tonumber(e)~=tonumber(oldcount)then
...
retstring=tostring(math.ceil(tonumber(e)))
else
retstring="0"
end
else
...
e=luci.sys.exec("cat /tmp/ad.conf | wc -l")
if tonumber(e)>0 then
